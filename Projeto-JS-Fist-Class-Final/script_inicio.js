...
//Transição do Banner Inicial

var time = 3000,
    Imagem_index = 0;
    imagens = document.querySelectorAll("#section_banner img");
    max = imagens.length;


    function proxima_imagem() {

        imagens[Imagem_index].classList.remove("selected");
        ...
        imagens[Imagem_index].classList.add("selected");
    }
...
function pi() {
  ...
  document.getElementById("resultado").innerHTML = Math.PI;
}
